...
// remove this when https://github.com/godogx/allure/pull/13 is merged
replace github.com/godogx/allure => github.com/AlaudaDevops/allure v0.0.0-20250120084502-53f2f19c70fb
